  ...
  return (
    <footer className="footer">
      <div className="footer-social-media">
        <div className="footer-social-medai-text">Follow us</div>
      ...
      <div className="footer-links-wrapper">
        ...
        <div className="footer-links-item">
          ...
          <p className="footer-description">
            We are an edufund online shopping platform committed to 
            providing a seamless and convenient shopping experience. 
            With a wide selection of high-quality products and 
            user-friendly interface, we strive to make online shopping 
            accessible and enjoyable for customers worldwide.
          </p>
        </div>
      </div>
    </footer>
